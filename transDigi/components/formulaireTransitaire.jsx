...
function TransdigiRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Erreur inscription transitaire', err);
      ...
      } else if (/(ninea)/i.test(raw) && /(existe|déjà|already)/i.test(raw)) {
        friendly = "Ce NINEA est déjà enregistré pour un autre compte.";
